            ...
            <div class="card-dark w-1/3 justify-center items-center">
                ...
                <div class="flex flex-col flex-1 w-full h-4/5 items-center">
                    <div class="checkbox-holder">
                        <input type="checkbox" name="upper-body" id="upper-body" class="appearance-none bg-transparent text-primary ml-4 mr-4">
                        <label for="upper-body" class="text-white">vrchná časť tela</label>
                    </div>
                    <div class="checkbox-holder">
                        <input type="checkbox" name="lower-body" id="lower-body" class="appearance-none bg-transparent text-primary ml-4 mr-4">
                        <label for="lower-body" class="text-white">spodná časť tela</label>
                    </div>
                    <div class="checkbox-holder">
                        <input type="checkbox" name="whole-body" id="whole-body" class="appearance-none bg-transparent text-primary ml-4 mr-4">
